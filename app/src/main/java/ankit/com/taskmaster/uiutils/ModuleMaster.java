...
public class ModuleMaster {
    ...
    public static void navigateToAnswers(Context context, String tagName, Pair<View, String>[] pairs) {
        ...
        args.add(bundle);
        args.add(bundle);
        intent.putExtra(BaseTabsActivity.ARGS_ACTIVITY_TITLE, tagName);
